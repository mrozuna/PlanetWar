...
public class Status {
	...
	public static String colGameWin="gameWin";
	public static String colGameLost="gameLost";
	public static String colGameDraw="gameDraw";
	public static String colStatusGameWin="statusGameWin";
	public static String colStatusGameLost="statusGameLost";
	public static String colStatusGameDraw="statusGameDraw";
